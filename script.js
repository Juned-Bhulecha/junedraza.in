    ...
    const interval = setInterval(() => {
        ...
        if (progress === 100) {
            ...
            setTimeout(() => {
                ...
                document.body.classList.add('loaded'); // Trigger animations immediately
                setTimeout(() => {
...
// === LENIS SMOOTH SCROLLING (Relaxed) ===
const lenis = new Lenis({
    duration: 2.0, // Increased duration for a very relaxed, floaty feel
    easing: (t) => Math.min(1, 1.001 - Math.pow(2, -10 * t)), // Smooth ease-out
    direction: 'vertical',
    gestureDirection: 'vertical',
    smooth: true,
    mouseMultiplier: 0.8, // Slightly lower for smoother wheel response
    smoothTouch: false,
    touchMultiplier: 2,
    infinite: false,
});
